    ...
    <div className="flex h-screen">
        ...
        <div className="border-primary/5 border-2 max-w-xs flex flex-col gap-2 justify-between shadow-md rounded-md p-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button variant={autoRecordEnabled ? 'destructive' : 'outline'} size={'icon'} onClick={toggleAutoRecord}>
              {autoRecordEnabled ? <BounceLoader color="white" size="30" /> : <PersonStanding />}
            </Button>
          </div>
          {/* Bottom Secion  */}
          <div className="flex flex-col gap-2">
      ...
      {loading && (
        <div className="z-50 absolute w-full h-full flex items-center justify-center bg-primary-foreground">
          Getting things ready . . . <BounceLoader color="red" size="30" />
        </div>
      )}
    </div>
  );
      ...
      <div className="text-xs text-muted-foreground">
        <ul className="space-y-4">
          ...
          <li>
            ...
            >
              {autoRecordEnabled ? <BounceLoader color="red" size="30" /> : <PersonStanding size={14} />}
            </Button>
          </li>
